...
driver = webdriver.Chrome(executable_path='D:\Working\Python\Gimkit bot\chromedriver.exe', options= options) 
...
def read_config():
    ...
    if config_file.is_file():
        ...
        question_position.tlX = int(config_object["QUESTION POSITION"]["tlX"])
        question_position.tlY = int(config_object["QUESTION POSITION"]["tlY"])
        question_position.brX = int(config_object["QUESTION POSITION"]["brX"])
        question_position.brY = int(config_object["QUESTION POSITION"]["brY"])

        red_answer_position.tlX = int(config_object["RED ANSWER POSITION"]["tlX"])
        red_answer_position.tlY = int(config_object["RED ANSWER POSITION"]["tlY"])
        red_answer_position.brX = int(config_object["RED ANSWER POSITION"]["brX"])
        red_answer_position.brY = int(config_object["RED ANSWER POSITION"]["brY"])

        orange_answer_position.tlX = int(config_object["ORANGE ANSWER POSITION"]["tlX"])
        orange_answer_position.tlY = int(config_object["ORANGE ANSWER POSITION"]["tlY"])
        orange_answer_position.brX = int(config_object["ORANGE ANSWER POSITION"]["brX"])
        orange_answer_position.brY = int(config_object["ORANGE ANSWER POSITION"]["brY"])
        
        green_answer_position.tlX = int(config_object["GREEN ANSWER POSITION"]["tlX"])
        green_answer_position.tlY = int(config_object["GREEN ANSWER POSITION"]["tlY"])
        green_answer_position.brX = int(config_object["GREEN ANSWER POSITION"]["brX"])
        green_answer_position.brY = int(config_object["GREEN ANSWER POSITION"]["brY"])

        blue_answer_position.tlX = int(config_object["BLUE ANSWER POSITION"]["tlX"])
        blue_answer_position.tlY = int(config_object["BLUE ANSWER POSITION"]["tlY"])
        blue_answer_position.brX = int(config_object["BLUE ANSWER POSITION"]["brX"])
        blue_answer_position.brY = int(config_object["BLUE ANSWER POSITION"]["brY"])
